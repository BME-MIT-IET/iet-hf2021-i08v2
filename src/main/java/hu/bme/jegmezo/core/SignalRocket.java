 ...
 *és egy táblán állnak, akkor elsütésével megnyerik a játékot, erről az osztály értesíti a hu.bme.jegmezo.core.Game-et.
 * Singleton osztály.
 */
public class SignalRocket implements Usable {
    ...
    /**
     *Visszaadja az egyetlen hu.bme.jegmezo.core.SignalRocket példányt, Singleton-pattern megvalósításához szükséges.
    ...
    /**
     * Egy karakter hívja meg, ha felvesz alkatrészt (hu.bme.jegmezo.core.SignalRocketPart),
     *  amit a hu.bme.jegmezo.core.SignalRocket eltárol a parts listájában.
